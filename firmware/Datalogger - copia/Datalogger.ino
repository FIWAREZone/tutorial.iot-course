...
//Task dataSenderTask(2000, TASK_FOREVER, &dataSenderCallback);
...
void dataSenderCallback(){
  int returnCode = ultralightSend(FIWARE_server,FIWARE_port,FIWARE_token,FIWARE_ID,dataReaderSensor());
   if (returnCode ==200){
